...
namespace ConsoleGameEngine.Systems
{
    ...
    /// </summary>
    internal class AnimationSystem : AEntitySetSystem<GameTime>
    {
        ...
        /// <summary>
        /// Updates the specified entity's animation.
        /// </summary>
        /// <param name="time">The game time</param>
        /// <param name="entity">The entity whose animation to process.</param>
